    ...
    二级: $js.toString(() => {
        ...
        if (orId === 'update_info') {
            VOD = {
                ...
                vod_play_url: '采集资源主题曲$https://cors.isteed.cc/https://raw.githubusercontent.com/n3rddd/N3RD/master/JN/N3RD/W/CTVThemeSong2.mp4',
            };
        } else {
            if (rule.classes) {
                ...
                if (current_vod && current_vod.type_name) {
                    VOD.vod_play_from = VOD.vod_play_from.split('$$$').map(it => '采集资源 | ' + it).join('$$$')
                }
            }
        }
    }),
